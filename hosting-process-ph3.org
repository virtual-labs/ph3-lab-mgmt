...
* Introduction
  ...
  process to be followed by an intergration engineer while hosting
  phase 3 lab units.
* Motivation
...
* Audience
  ...
  who wants to host a unit on receving hosting request.
...
** Hosting Lab and Experiments
  In this section, we will discuss about hosting Lab and Experiments.
...
** (Re)Hosting Lab and Experiments
  In this section, we will discuss about (re)hosting Lab and Experiments.
...
** Testing
  In this section, we will discuss about testing of an hosted unit.
